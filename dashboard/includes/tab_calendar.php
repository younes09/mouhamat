        ...
        <div class="row g-4">
          ...
          <div class="col-12 col-lg-7">
            <div class="premium-card p-4 h-100 d-flex flex-column">
              ...
              <div class="flex-grow-1 overflow-auto pe-1" id="calendarRequestsContainer" style="max-height: 400px; min-height: 250px;">
              ...
              <div class="d-flex justify-content-between align-items-center pt-3 border-top mt-3 flex-wrap gap-2">
                ...
                <button id="calendarAddNewCaseBtn" onclick="openAddCaseModalFromCalendar()" class="btn btn-outline-success btn-sm d-flex align-items-center gap-2">
